...
// Source SVGs: These are derived from the RollerCoaster.dev brand assets
// To regenerate: If the original SVGs change, use `base64 -w 0 path/to/svg-file`
// (or online tool) and update the string below. These match the brand assets used in the app.
...
function generateStyles(): string {
  ...
  return `
    <style>
      /* Local Font Definitions - matching main.css */
      @font-face {
